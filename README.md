# MangaDex Sync — Standalone

Export **and import** your MangaDex library to/from **MyAnimeList** and **AniList** — with scores, statuses, and optional chapter progress — all from a single Python script, no installation needed.
...
- The app will fall back to your browser automatically — everything still works
- On Linux a system package may be needed for the native window; the app will print the exact command for your distro
